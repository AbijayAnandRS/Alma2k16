 ...
 */
public class selfdfnce extends AppCompatActivity {
    MenuDrawer mDrawer;
    LinearLayout l1,l2,l3,l4,l5,l6;Button b1;Button c1;
    Button reg1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mDrawer=MenuDrawer.attach(selfdfnce.this);
        mDrawer.setMenuView(R.layout.menudrawer);
        mDrawer.setContentView(R.layout.selfdefence);
        ...
        Animation asd= AnimationUtils.loadAnimation(selfdfnce.this, R.anim.start);
        Animation ads=AnimationUtils.loadAnimation(selfdfnce.this,R.anim.stop);
        ...
        c1=(Button)findViewById(R.id.cnse);
        reg1=(Button)findViewById(R.id.selfreg);
        ...
        reg1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ni==null)
                {
                    Toast t=Toast.makeText(selfdfnce.this,"Please Connect to Network",Toast.LENGTH_LONG);
                    t.show();
                }
                else
                {
                    Dialog thj=new Dialog(selfdfnce.this,android.R.style.Theme_Light_NoTitleBar_Fullscreen);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dlg = new Dialog(selfdfnce.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ActivityCompat.checkSelfPermission(selfdfnce.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                message.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        d = 1;
                        dlg.cancel();
                        final Dialog fgh = new Dialog(selfdfnce.this);
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent ij=new Intent(selfdfnce.this,fg);
                    startActivity(ij);
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Intent ij=new Intent(selfdfnce.this,gh);
            startActivity(ij);
            this.finish();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
