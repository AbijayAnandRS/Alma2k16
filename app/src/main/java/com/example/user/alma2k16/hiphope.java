 ...
 */
public class hiphope extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawer=MenuDrawer.attach(hiphope.this);
        mDrawer.setMenuView(R.layout.menudrawer);
        mDrawer.setContentView(R.layout.hiphop);
        ...
        r1=(Button)findViewById(R.id.paperreg);
        ct1=(Button)findViewById(R.id.paperct);
        ...
        Animation asd=AnimationUtils.loadAnimation(hiphope.this,R.anim.start);
        Animation ads=AnimationUtils.loadAnimation(hiphope.this,R.anim.stop);
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ni==null)
                {
                    Toast t=Toast.makeText(hiphope.this,"Please Connect to Network",Toast.LENGTH_LONG);
                    t.show();
                }
                else
                {
                    Dialog thj=new Dialog(hiphope.this,android.R.style.Theme_Light_NoTitleBar_Fullscreen);
        ...
        ct1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dlg = new Dialog(hiphope.this);
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ActivityCompat.checkSelfPermission(hiphope.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                message.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        d=1;
                        dlg.cancel();
                        final Dialog fgh=new Dialog(hiphope.this);
        ...
        getSupportActionBar().setTitle("PAPER QUILLING");
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent ij=new Intent(hiphope.this,fg);
                    startActivity(ij);
    ...
    public void onBackPressed() {
        try {
            ...
            Intent ij=new Intent(hiphope.this,gh);
            startActivity(ij);
            this.finish();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
