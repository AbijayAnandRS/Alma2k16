 ...
 */
public class salsaa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawer=MenuDrawer.attach(salsaa.this);
        mDrawer.setMenuView(R.layout.menudrawer);
        mDrawer.setContentView(R.layout.salsa);
        ...
        Animation asd= AnimationUtils.loadAnimation(salsaa.this, R.anim.start);
        Animation ads=AnimationUtils.loadAnimation(salsaa.this,R.anim.stop);
        abc.startAnimation(asd);
        cde.startAnimation(ads);
        Toolbar toolbar=(Toolbar)findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("SALSA");
        ...
        c1=(Button)findViewById(R.id.cnsal);
        reg1=(Button)findViewById(R.id.salreg);
        reg1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ni==null)
                {
                    Toast t=Toast.makeText(salsaa.this,"Please Connect to Network",Toast.LENGTH_LONG);
                    t.show();
                }
                else
                {
                    Dialog thj=new Dialog(salsaa.this,android.R.style.Theme_Light_NoTitleBar_Fullscreen);
                ...
                c1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final Dialog dlg = new Dialog(salsaa.this);
                        ...
                        call.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (ActivityCompat.checkSelfPermission(salsaa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        message.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                d = 1;
                                dlg.cancel();
                                final Dialog fgh = new Dialog(salsaa.this);
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent ij=new Intent(salsaa.this,fg);
                    startActivity(ij);
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Intent ij=new Intent(salsaa.this,gh);
            startActivity(ij);
            this.finish();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
